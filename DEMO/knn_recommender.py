...
def parse_args():
    ...
    parser.add_argument('--path', nargs='?', default='/home/hedgehog/Desktop/VRONDEMO/MyDataSciencePortfolio/movie_recommender/data/MovieLens',
    ...
    parser.add_argument('--movie_name', nargs='?', default='',
                        help='provide your favorite movie name')
...
if __name__ == '__main__':
    ...
    # getting movie name using voice
